...
def collect_discovery_papers(rejected_papers, sent_history, starred_papers, explored_paths):
...
def collect_papers(feedback_data=None):
    ...
    discovery = collect_discovery_papers(rejected_papers, sent_history, starred_papers, explored_paths)
    if discovery["papers"]:
